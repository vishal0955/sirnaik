...
//                     <h5>Giles Conn</h5>
//                     <p className="mb-1 text-muted" >Senior - Research | User Role: Employee</p>
  ...
  return (
    <div className="container-fluid px-3 py-3">
      <div className="row g-3">
        ...
        <div className="col-lg-8 col-md-12">
          {/* Profile Card */}
          <div className="p-3 border rounded bg-white d-flex flex-wrap align-items-center">
            ...
            <div className="flex-grow-1">
              ...
              <div className="row mt-3 text-center">
                <div className="col-6 col-sm-3">
                  <h6 className="mb-1" onClick={() => navigate("/tasklist")}>Open Tasks</h6>
                  <p className="fw-bold mb-0">4</p>
                </div>
                <div className="col-6 col-sm-3" onClick={() => navigate("/project")}>
                  <h6 className="mb-1">Projects</h6>
                  <p className="fw-bold mb-0">2</p>
                </div>
                <div className="col-6 col-sm-3 mt-3 mt-sm-0">
          ...
          <div className="bg-white border rounded p-3 mt-3">
            ...
            <table className="table table-borderless">
              <tbody>
                ...
                <tr><td><strong>Gender</strong></td><td>♂ Male</td></tr>
                <tr><td><strong>Work Anniversary</strong></td><td>2 months from now</td></tr>
                <tr><td><strong>Email</strong></td><td>modesta.johnson@example.net2</td></tr>
                <tr><td><strong>Hourly Rate</strong></td><td>$74</td></tr>
                <tr><td><strong>Address</strong></td><td>11960 Kyleigh Cove Suite 484 Octaviaborgh, AL 75404</td></tr>
                <tr><td><strong>Language</strong></td><td>English</td></tr>
                <tr><td><strong>Marital Status</strong></td><td>Single</td></tr>
